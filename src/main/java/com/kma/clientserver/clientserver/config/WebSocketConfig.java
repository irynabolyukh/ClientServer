    ...
    class StudentHandler extends TextWebSocketHandler {
        ...
        public void afterConnectionEstablished(WebSocketSession session) throws Exception{
            ...
            if(studentList.isEmpty()){
                session.sendMessage(new TextMessage("{\"message\": \"Can't get students!\"}"));
            }
            else{
        ...
        public void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception{
            ...
            if(enrollments.isEmpty()) {
                session.sendMessage(new TextMessage("{\"message\": \"Can't get enrollments!\"}"));
            }
            else{
                System.out.println(Arrays.toString(enrollments.toArray()));
                StringBuilder answer = new StringBuilder();
                answer.append("[");
